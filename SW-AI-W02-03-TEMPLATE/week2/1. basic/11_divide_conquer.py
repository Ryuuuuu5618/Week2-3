...
def find_max_divide_conquer(arr, left, right):
    ...
    #     if arr[left + i] > left_big:
    #         left_big = arr[left + i]

    #     if arr[right - i] > right_big:
    #         right_big = arr[right - i]
    ...
    leftBig = find_max_divide_conquer(arr, left, mid)
    rightBig =  find_max_divide_conquer(arr, mid + 1, right)
